...
* Changed the required Ace3 and LibSharedMedia libraries to be embedded in the addon instead of installed separately.
...
* Fixed the Moonfire debuff icon not being shown.
